...
function Introduction() {
	return <div className="flex flex-col justify-center">
		<div className="grid grid-cols-3 content-center">
			<div className="flex flex-col justify-center content-start col-span-2">
				...
				<p className="motion-safe:animation delay-2s fade-in text-left mt-4 text-sm md:text-xl">
					...
					Currently, I am actively engaged in mastering <a href="https://www.rust-lang.org/" className="text-blue-600 font-bold dark:text-rose-950">{"Rust"}</a>{"."}, a cutting-edge programming language that aligns perfectly with my interests.
				</p>
		...
		<div className="self-center motion-safe:animation delay-3s animate-bounce mt-8">
			<a href="#code-yew">
...
function CodeYew() {
	return <div className="flex flex-col justify-center h-full">
		<div className="flex flex-row justify-center items-center h-full">
			<div className="relative w-[76em] h-[25em] mr-10">
			...
			<div className="flex flex-col justify-center items-start pl-10">
				<p className="md:text-4xl mt-4">Code Yew Extension</p>
				<p className="mt-8">Vscode Extension that provide syntax highlighting & language feature support for Yew HTML macro in Rust.</p>
			</div>
